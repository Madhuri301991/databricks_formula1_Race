...
# let spark decide which record to keep and which to remove in case of duplicate records
results_dedupded_df=results_final_df.dropDuplicates(['race_id','driver_id'])
...
merge_delta_data(results_dedupded_df,'f1_processed','results',processed_folder_path,merge_condition,'race_id')
...
#####replace only the new data received not overwrite the entire table
...
# MAGIC 
# MAGIC -- no output means no duplicates exist
