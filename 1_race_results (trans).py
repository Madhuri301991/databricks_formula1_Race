...
#Assume above tables have no incremental load
...
final_df=race_results_df.select('race_id','race_name','race_year','race_date','circuit_location','driver_number','driver_name','driver_nationality','team','grid','fastest_lap','race_time','points','position','result_file_date')\
