...
# MAGIC i] driverId renamed to driver_id
# MAGIC ii] driverRef renamed to driver_ref
# MAGIC iii] ingestion date added
# MAGIC iv] name added with concatention of forename and surname
...
# MAGIC i] name.forename
# MAGIC ii] name.surname
# MAGIC iii] url
