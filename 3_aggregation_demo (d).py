...
.withColumnRenamed('count(DISTINCT race_name)','no_of_races').show()

# COMMAND ----------

demo_df.groupBy("driver_name").agg(sum("points").alias("total_points"),countDistinct("race_name").alias("no_of_races")).show()
